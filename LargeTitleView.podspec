...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of LargeTitleView.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/shizhou@live.com/LargeTitleView'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'shizhou@live.com' => 'shizhou@live.com' }
  s.source           = { :git => 'https://github.com/shizhou@live.com/LargeTitleView.git', :tag => s.version.to_s }
